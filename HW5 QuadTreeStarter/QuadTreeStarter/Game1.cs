...
namespace QuadTreeStarter
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            _rootNode = new QuadTreeNode(0, 0, GraphicsDevice.Viewport.Width, GraphicsDevice.Viewport.Height);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            _mouseQuad = _rootNode.GetContainingQuad(_mouseRect);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            List<Rectangle> rects = _rootNode.GetAllRectangles();
